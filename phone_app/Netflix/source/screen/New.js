        ...
        <View style={styles.view0}>
            <View style={styles.view1}>
                ...
                <View style={styles.icn1}>
                    ...
                    <Image style={styles.img1} source={require('../../assets/1.jpg')} />
                </View>
            </View>
            ...
            <ScrollView horizontal={true}>
                <View style={styles.view15}>
                    <Image style={styles.img3} source={require('../../assets/1.jpg')} />
                    <Image style={styles.img3} source={require('../../assets/2.jpg')} />
                    <Image style={styles.img3} source={require('../../assets/3.jpg')} />
                    <Image style={styles.img3} source={require('../../assets/4.jpg')} />
                    <Image style={styles.img3} source={require('../../assets/1.jpg')} />
                    <Image style={styles.img3} source={require('../../assets/1.jpg')} />
                    <Image style={styles.img3} source={require('../../assets/1.jpg')} />
                    <Image style={styles.img3} source={require('../../assets/1.jpg')} />
